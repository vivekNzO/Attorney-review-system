    ...
    <div className="min-h-[calc(100vh-84px)] flex">
      ...
      <div className="flex flex-col items-center justify-center w-full md:w-1/2 bg-white px-10 lg:px-20">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-500 mb-6 text-center">
            Connect with clients who need your guidance.
          </p>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button disabled={authLoading} className="w-full bg-black/80 text-white py-2 font-semibold hover:bg-black rounded-xl transition-colors">
              Sign up
            </button>
          </form>
      ...
      <div className="hidden md:flex w-1/2 items-center justify-center p-10">
        <div className="text-center px-2">
          <img src="/law3.jpg" className="mx-auto" />
          <h1 className="text-2xl font-semibold mt-6">
            Showcase Your Legal Expertise.
          </h1>
          <p className="text-gray-600 mt-2">
            Expand your professional reach and showcase your strengths to
            clients actively searching for trusted legal advisors.
          </p>
        </div>
      </div>
    </div>
